...
{
    public class ClassroomClimateDetail : Audit
    {
        [Key]
        public long Id { get; set; }

        [Required]
        public long ClassroomClimateId { get; set; }
        ...
        [ForeignKey("ClassroomClimateId")]
        public virtual ClassroomClimate ClassroomClimate { get; set; }
