...
{
    public class EvaluationProcessDetail: Audit
    {
        [Key]
        public long Id { get; set; }

        [Required]
        public long EvaluationProcessId { get; set; }
        ...
        [ForeignKey("EvaluationProcessId")]
        public virtual EvaluationProcess EvaluationProcess { get; set; }
