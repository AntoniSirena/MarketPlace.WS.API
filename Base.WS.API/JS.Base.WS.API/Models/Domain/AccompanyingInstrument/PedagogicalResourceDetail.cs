...
{
    public class PedagogicalResourceDetail: Audit
    {
        ...
        [Required]
        public long PedagogicalResourceId { get; set; }
        ...
        [ForeignKey("PedagogicalResourceId")]
        public virtual PedagogicalResource PedagogicalResource { get; set; }
