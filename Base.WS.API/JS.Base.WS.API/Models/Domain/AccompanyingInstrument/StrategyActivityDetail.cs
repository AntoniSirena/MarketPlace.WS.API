...
{
    public class StrategyActivityDetail : Audit
    {
        ...
        [Required]
        public long StrategyActivityId { get; set; }
        ...
        [ForeignKey("StrategyActivityId")]
        public virtual StrategyActivity StrategyActivity { get; set; }
