...
{
    public class RelationFatherMotherDetail : Audit
    {
        [Key]
        public long Id { get; set; }

        [Required]
        public long RelationFatherMotherId { get; set; }
        ...
        [ForeignKey("RelationFatherMotherId")]
        public virtual RelationFatherMother RelationFatherMother { get; set; }
